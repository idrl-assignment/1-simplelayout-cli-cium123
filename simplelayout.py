...
def main():
    ...
    parser.add_argument('--board_grid', help="Layout_panel_resolution",
                        type=int)
    parser.add_argument('--unit_grid', help="Rectangular_component_resolution",
                        type=int)
    ...
    parser.add_argument('--outdir', '--o', help="content_of_result",
                        type=str)
